...
```
git clone https://github.com/altixco/django-postgres-dokku pl4n3t
cd pl4n3t
```
...
```
dokku apps:create pl4n3t
dokku postgres:create pl4n3t
dokku postgres:link pl4n3t pl4n3t
```
...
```
dokku config:set pl4n3t ENVIRONMENT=production DJANGO_SECRET_KEY=....
```
...
```
git remote add production dokku@<my-dokku-server.com>:pl4n3t
```
